...
<br>
<br>
<section id="" class="justify-content-center py-4" style="height: 50vh">
    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="row justify-content-center">
                                <div class="col-lg-6 col-sm-6">
                                    <div class="dropdown">
                                        <button class="btn btn-outline-success w-100 dropdown-toggle mb-3" type="button"
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            ...
                                            <li><a class="dropdown-item"
                                                    href="/admin?kategori={{ $kat->id }}">{{ $kat->ket_kategori }}</a>
                                            </li>
                                            @endforeach
                                        </ul>
                                    </div>
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <form action="/admin" autocomplete="off" method="get">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> @if ($as['status'] == 'Menunggu')
                                                ...
                                                @else
                                                <button type="submit" class="btn btn-secondary btn-sm mb-3 w-100"
                                ...
                                <table class="table border-top">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $as->input_aspirasi->lokasi }}</td>
                                            <td>{{ $as->input_aspirasi->ket }}</td>
                                            <td>{{ $as->input_aspirasi->created_at }}</td>
                                            <td>
